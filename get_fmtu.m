...
%-----------------------------------------------------------
% key routines
cap_fmt_misfit('OUTPUT_DIR', evid, model, depth, nsol_grid);
...
stp3('OUTPUT_DIR/', evid, model, depth, nsol_rand, kval, ncell, wpol);
CAP_unc_binary(evid, 'OUTPUT_DIR/', model, depth, nsol_rand, kval, wpol, 'OUTPUT_DIR/');
%-----------------------------------------------------------
delete(gcp('nocreate'));
